...
FIELDS = [
    ...
    ("name",        297,   501,  161.0, "right", 10, "שם פרטי ומשפחה"),
    ("zeout",       169,   274,  161.0, "right", 10, "ת.ז."),
    ("phone",        13,   110,  161.0, "right", 10, "טלפון"),
    ("address",     252,   528,  192.5, "right", 10, "כתובת מלאה"),
    ("email",        13,   225,  192.5, "right",  9, "מייל"),
    ("avour",        13,   191,  254.5, "right",  9, "התרומה מיועדת עבור"),
    ("notes",        13,   218,  274.5, "right",  9, "הערות"),
    ...
    ("branchName",  330,   400,  467.0, "center", 10, "שם הסניף"),
    ("holder",      205,   470,  566.0, "right", 10, "שם בעלי החשבון"),
    ("holderId",    122,   250,  566.0, "right", 10, "מס׳ זהות / ח.פ."),
